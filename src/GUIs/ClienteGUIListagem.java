...
public class ClienteGUIListagem extends JDialog {
    ...
    public static void main(String[] args) {
        new ClienteGUIListagem();
    }

    JPanel painelTa = new JPanel();
    static DefaultTableModel modelo = new DefaultTableModel(new String[]{"ID Pessoa", "Estado Civil"}, 0);
    static JTable tabela = new JTable(modelo);
    JScrollPane scroll = new JScrollPane(tabela);
    List<String> lista = new ArrayList<>();

    public ClienteGUIListagem(List<String> texto, Container cp2) {
    ...
    public ClienteGUIListagem() {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    public void atualizaTabela() {
        DefaultTableModel modelo = new DefaultTableModel(new String[]{"ID Pessoa","Estado Civil"}, 0);
        int aux = 0;
