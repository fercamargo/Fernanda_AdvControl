...
public class PessoaGUIListagem extends JDialog {
    ...
    static DefaultTableModel modelo = new DefaultTableModel(new String[]{"ID Pessoa","Nome","CPF","Telefone","Data de Cadastro","Sexo"}, 0);
    ...
    public PessoaGUIListagem() {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    public void atualizaTabela() {
        DefaultTableModel modelo = new DefaultTableModel(new String[]{"ID Pessoa","Nome","CPF","Telefone","Data de Cadastro","Sexo"}, 0);
        int aux = 0;
